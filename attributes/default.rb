...
# default['chef_client']['handler']['slack']['webhooks']['webhook1']['send_start_notice'] = nil
...
# Whether to send a notice to when the Chef run starts
default['chef_client']['handler']['slack']['send_start_notice'] = false
